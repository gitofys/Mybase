    ...
    private EditText.OnEditorActionListener section1_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(0).getText().toString().matches("")|| Integer.parseInt(et_res.get(0).getText().toString())< 3 || Integer.parseInt(et_res.get(0).getText().toString())>MaxPattern)
                {
                    et_res.get(0).setText(Integer.toString(init_res[0]));
                    Dialog_Pane("Error","D-Res. range is 3~" + MaxPattern + "!");
                    return false; // consume.
    ...
    private EditText.OnEditorActionListener section2_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(1).getText().toString().matches("")|| Integer.parseInt(et_res.get(1).getText().toString())< 3 || Integer.parseInt(et_res.get(1).getText().toString())>MaxPattern)
                {
    ...
    private EditText.OnEditorActionListener section3_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(2).getText().toString().matches("")|| Integer.parseInt(et_res.get(2).getText().toString())< 3 || Integer.parseInt(et_res.get(2).getText().toString())>MaxPattern)
                {
    ...
    private EditText.OnEditorActionListener section4_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(3).getText().toString().matches("")|| Integer.parseInt(et_res.get(3).getText().toString())< 3 || Integer.parseInt(et_res.get(3).getText().toString())>MaxPattern)
                {
    ...
    private EditText.OnEditorActionListener section5_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(4).getText().toString().matches("")|| Integer.parseInt(et_res.get(4).getText().toString())< 3 || Integer.parseInt(et_res.get(4).getText().toString())>MaxPattern)
                {
